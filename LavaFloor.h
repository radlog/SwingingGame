...
public:
	LavaFloor();
	~LavaFloor();
	LavaFloor(LPCSTR texture, LPCSTR texture_normal = "assets/lava_selfmade_normal.png", LPCSTR texture_noise= "assets/lava_noise.png", int tiles = 200,float scale = 1.0f);
