...
public:
	LavaFloor();
	~LavaFloor();
	// lava floor initializer taking tiles, scale, texture, normal texture, noise texture
	explicit LavaFloor(int tiles = 200, float scale = 1.0f, LPCSTR texture = "assets/lava_selfmade_diffuse.png", LPCSTR texture_normal = "assets/lava_selfmade_normal.png", LPCSTR texture_noise = "assets/lava_noise.png");
