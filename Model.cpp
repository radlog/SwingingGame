...
HRESULT Model::set_default_input_layout()
{
...
HRESULT Model::set_input_layout(D3D11_INPUT_ELEMENT_DESC iedesc[], const int size)
{
...
HRESULT Model::create_default_sampler_for_texture()
{
...
HRESULT Model::load_texture(LPCSTR filename)
{	
	return D3DX11CreateShaderResourceViewFromFile(device_, filename, nullptr, nullptr, &texture_, nullptr);
}

HRESULT Model::load_normal(LPCSTR filename)
{
	return D3DX11CreateShaderResourceViewFromFile(device_, filename, nullptr, nullptr, &normal_, nullptr);
}

void Model::update_constant_buffer_full(const XMMATRIX world_view_projection, const XMMATRIX view_projection, const XMVECTOR directional_light_vector,
...
void Model::update_constant_buffer_time_scaled(const XMMATRIX world_view_projection, const XMMATRIX view_projection, const XMVECTOR directional_light_vector,
...
HRESULT Model::create_constant_buffer_time_scaled()
{
	cb_ = &cb_time_scaled_lighted_;
	return create_constant_buffer(sizeof(cb_time_scaled_lighted_));
}

HRESULT Model::create_constant_buffer_lighted()
{
	cb_ = &cb_lighted_;
	return create_constant_buffer(sizeof(cb_lighted_));
}

HRESULT Model::create_constant_buffer_simple()
{
	cb_ = &cb_simple_;
	return create_constant_buffer(sizeof(cb_simple_));
}

HRESULT Model::create_constant_buffer(UINT byte_width)
{
...
HRESULT Model::update_default_vertex_buffer(void *vertices, const UINT byte_width)
{
...
HRESULT Model::create_index_buffer()
{
	D3D11_BUFFER_DESC desc;
	ZeroMemory(&desc, sizeof(desc));
