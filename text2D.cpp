...
void Text2D::RenderText(void)
{
	...
	for(unsigned int i=0; i < s2d.size(); i++)
	{
		...
		for(unsigned int j = 0;j < s2d[i].s.length(); j++)
		{
			...
			vertices[current_char*6].texcoord.x = texx;
			vertices[current_char*6].texcoord.y = texy;
			vertices[current_char*6+1].texcoord.x = texx + 1.0f/ 26.0f;
			vertices[current_char*6+1].texcoord.y = texy;
			vertices[current_char*6+2].texcoord.x =texx + 1.0f/ 26.0f;
			vertices[current_char*6+2].texcoord.y = texy+ 1.0f/ NUMLINES;
			vertices[current_char*6+3].texcoord.x = texx;
			vertices[current_char*6+3].texcoord.y = texy;
			vertices[current_char*6+4].texcoord.x = texx + 1.0f/ 26.0f;
			vertices[current_char*6+4].texcoord.y = texy+ 1.0f/ NUMLINES;
			vertices[current_char*6+5].texcoord.x = texx;
			vertices[current_char*6+5].texcoord.y = texy+ 1.0f/ NUMLINES;
